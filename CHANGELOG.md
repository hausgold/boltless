...
* Corrected some RuboCop glitches ([#30](https://github.com/hausgold/boltless/pull/30))
...
* Corrected some RuboCop glitches ([#28](https://github.com/hausgold/boltless/pull/28))

### 2.11.0 (20 May 2026)

* Corrected some RuboCop glitches ([#27](https://github.com/hausgold/boltless/pull/27))
...
* Dropped Rails 7.1 support ([#21](https://github.com/hausgold/boltless/pull/21))
...
* Upgraded to Ubuntu 24.04 on Github Actions ([#20](https://github.com/hausgold/boltless/pull/20))
* Migrated to hausgold/actions@v2 ([#19](https://github.com/hausgold/boltless/pull/19))

### 2.3.0 (26 December 2025)

* Added Ruby 4.0 support ([#18](https://github.com/hausgold/boltless/pull/18))
* Dropped Ruby 3.2 and Rails 7.1 support ([#17](https://github.com/hausgold/boltless/pull/17))

### 2.2.0 (19 December 2025)

* Migrated to a shared Rubocop configuration for HAUSGOLD gems ([#16](https://github.com/hausgold/boltless/pull/16))
